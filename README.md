...
Após pouco mais de uma década de experiência em Gestão Publica, decidi direcionar minha carreira para novos caminhos, focando em desenvolvimento de software.  Busco novas oportunidades e desafios. Atualmente, estou aprofundando meus conhecimentos em linguagens de programação como Ruby e Rails, além de focar no desenvolvimento de aplicativos móveis utilizando Kotlin/Java, Flutter e Swift.
Sou graduado em Ciência da Computação (SOBEU, 2009). Possuo habilidades sólidas em comunicação, sou proativo, focado e sempre entusiasta por aprender e aplicar novas tecnologias. Participando ativamente de uma Comunidade de Inovação, tenho a intenção de promover tecnologias e inovações como cultura transformadora na região onde moro. 
